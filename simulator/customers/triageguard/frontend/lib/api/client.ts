/**
 * Thin fetch wrapper for the TriageGuard backend.
 *
 * - Reads `NEXT_PUBLIC_TRIAGEGUARD_API_URL` once at module load (default
 *   `http://localhost:8002`).
...
export const API_BASE_URL: string = (() => {
  const raw =
    typeof process !== "undefined"
      ? process.env.NEXT_PUBLIC_TRIAGEGUARD_API_URL
      : undefined;
...
/**
 * Make a JSON request against the TriageGuard backend.
 *
