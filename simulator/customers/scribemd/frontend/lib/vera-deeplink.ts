 ...
 * fall back to the public dashboard. This is the *only* place ScribeMD
 * crosses the streams with Vera — the EHR mock surfaces a tiny
 * "View audit trail" link out of courtesy. Everywhere else the
 * customer surface stays Vera-agnostic.
 */
