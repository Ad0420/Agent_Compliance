...
from simulator.customers.scribemd.backend import auth
from simulator.customers.scribemd.backend.config import Settings, get_settings
from simulator.customers.scribemd.backend.schemas import LoginRequest, MeResponse
...
async def logout(
    ...
    auth.revoke_session(scribemd_session)
