  ...
  return (
    <section className="v4-section">
      <V4SectionHeader
        ...
        sub="Today, when an AI agent makes a decision your customer disputes, your team scrambles to reconstruct what happened. The reconstruction isn't verifiable."
      />
