...
#
# Note: PHI-shape detection lives in
# ``backend/app/services/phi_detector.py`` and is wired into the action
# routes (``backend/app/routes/actions.py``). The PR #195 bridge guard
# that used to live here is now gone; see Phase 1 PR 5 (Stream C / C3).
