...
| Pack-not-installed warning | integration: org with no pack → calls return ALLOW with warning header + dashboard banner; PDF generation blocked until pack installed | gap |
